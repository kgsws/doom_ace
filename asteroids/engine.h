...
int W_CheckNumForName(char *name) __attribute((regparm(1)));
...
void V_DrawPatch(int x, int y, int screen, void *patch) __attribute((regparm(2)));
void V_MarkRect(int x, int y, int w, int h) __attribute((regparm(2)));
...
void AM_drawMline(map_line_t*, int) __attribute((regparm(2)));
