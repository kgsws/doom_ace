...
// FLAGS extra (inventory) [shared with weapon]
#define MFE_INVENTORY_QUIET	0x00000001

// FLAGS extra (weapon)
#define MFE_WEAPON_NOAUTOFIRE	0x00010000
#define MFE_WEAPON_NOALERT	0x00020000
#define MFE_WEAPON_AMMO_OPTIONAL	0x00040000
#define MFE_WEAPON_ALT_AMMO_OPTIONAL	0x00080000
#define MFE_WEAPON_AMMO_CHECKBOTH	0x00100000
#define MFE_WEAPON_PRIMARY_USES_BOTH	0x00200000
#define MFE_WEAPON_ALT_USES_BOTH	0x00400000
#define MFE_WEAPON_NOAUTOAIM	0x00800000
