...
hook_t hook_list[] =
{
	...
	{0x0001d4a9, CODE_HOOK | HOOK_RELADDR_ACE, (uint32_t)snake_drawer},
	// replace menu input
	{0x0001d14a, CODE_HOOK | HOOK_RELADDR_ACE, (uint32_t)snake_input},
	// disable 'wipe' when playing SNAKE!
	{0x0001d4b4, CODE_HOOK | HOOK_UINT16, 0x9090}, // two 'nop's
	// invert 'run key' function (auto run)
	{0x0001fbe5, CODE_HOOK | HOOK_UINT8, 0x01},
	// import some variables from DATA segment
	{0x0002B790, DATA_HOOK | HOOK_IMPORT, (uint32_t)&gametic},
